...
16. [ ] Do prompt 15 again but this time ensuring to connect the app to firsebase cloud firstore of the firebase project connected to this app. Update the stored re-CAPTCHA key for the web-app version of the app if need be.
